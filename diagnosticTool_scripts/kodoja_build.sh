...
# /home/ae42909/viral_diagnostics/diagnosticTool_scripts/kodoja_build.py --output_dir /home/ae42909/Scratch/kodoja_db/ --threads 10 --db_tag 'plnVir'

# All vir genomes downloaded already in out_dir, add only plant viruses (no host)
# /home/ae42909/viral_diagnostics/diagnosticTool_scripts/kodoja_build.py --output_dir /home/ae42909/Scratch/kodoja_db/ --threads 10 --db_tag 'allVir' --no_download --all_viruses
