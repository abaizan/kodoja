...
#$ -pe smp 10
THREADS=10
DBNAME=/mnt/shared/scratch/ae42909/201609_BBSRC_Diagnostics/kraken/customdataset/RD_build
...
# Add the back traslated virus sequences from RefSeq (cp from /home/ae42909/Scratch/emboss_transeq/)

 kraken-build --add-to-library retranslated_RefSeqViruses.fna --db $DBNAME
